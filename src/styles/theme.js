...
export const styles = {
  ...
  batteryShell: {
    width: 46, height: 15, border: "2px solid #9a9884", borderRadius: 3,
    padding: 2, backgroundColor: "rgba(4,8,9,0.72)",
    display: "flex", alignItems: "stretch", gap: 2,
    boxSizing: "border-box",
  },
  batterySeg: {
    flex: 1, borderRadius: 1, minWidth: 0,
    transitionProperty: "background-color", transitionDuration: "400ms",
  },
  batteryCap: { width: 3, height: 8, backgroundColor: "#9a9884", borderRadius: "0 2px 2px 0" },
