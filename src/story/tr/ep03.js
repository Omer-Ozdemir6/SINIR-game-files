  ...
  nodes: {
    ...
    n_vitray_panel: {
      ...
      interaction: {
        kind: "rings",
        variant: "vitray",
        title: "AİLE VİTRAYI — CAMI HİZALA",
        rings: [
          { label: "İÇ", color: "#6aaa7a", step: 30, offset: 210, shards: ["#8ec5a0", "#5a9a6a", "#a8d4b8", "#8ec5a0", "#5a9a6a", "#8ec5a0", "#a8d4b8", "#5a9a6a"] },
          { label: "ORTA", color: "#c88a9a", step: 24, offset: 168, shards: ["#d4a0a8", "#a8626e", "#e4c0c6", "#d4a0a8", "#a8626e", "#d4a0a8", "#e4c0c6", "#a8626e"] },
          { label: "DIŞ", color: "#aa8ab8", step: 40, offset: 280, shards: ["#c4a4c8", "#8e5f96", "#dcc4e0", "#c4a4c8", "#8e5f96", "#c4a4c8", "#dcc4e0", "#8e5f96"] },
        ],
    ...
    n_fanus_kurtul: {
      cost: 1,
      events: [
        { type: "narrate", text: "Botlar duraksıyor, hırlayarak odadan dışarı, koridora doğru fırlıyor. Seni kaçtı sanıyor! Yatağın altından telaşla sürünürken tabletin elinden kayıp yatağın demir ayağına çarpıyor — ekranının köşesinde çatırdayan bir çatlak hattı beliriyor. Üstün başın kurbanların kanıyla kaplanmış, tabletini kavrayıp sessizce aşağı hole süzülüyorsun. Diş cebinde, üç yadigâr da hazır." },
    ...
    n_final_yol: {
      ...
      choices: [
        ...
        { id: "atla", text: "Kırık dolabın üzerinden atlayarak kestirme yolu dene", next: "n_final_atla" },
      ],
    },
