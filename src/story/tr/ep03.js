  ...
  nodes: {
    ...
    n_vitray_panel: {
      ...
      interaction: {
        ...
        rings: [
          { label: "İÇ", color: "#6aaa7a", step: 30, offset: 210, shards: ["#8ec5a0", "#e8e4d4", "#c4a4c8", "#d4a0a8", "#a8d4b8", "#c8b8d8", "#d8c8b4", "#b4d8c4"] },
          { label: "ORTA", color: "#c88a9a", step: 24, offset: 168, shards: ["#d4a0a8", "#a8d4b8", "#c4a4c8", "#e8e4d4", "#8ec5a0", "#d8b8c4", "#b4c8d8", "#c8d4a8", "#d4b4c8"] },
          { label: "DIŞ", color: "#aa8ab8", step: 40, offset: 280, shards: ["#c4a4c8", "#8ec5a0", "#e8e4d4", "#d4a0a8", "#b4d8c4", "#d8c8b4", "#a8b8d4", "#c8a8b4", "#8ec5a0", "#d4b8d4"] },
        ],
