  ...
  nodes: {
    ...
    n_vitray_panel: {
      ...
      interaction: {
        ...
        rings: [
          { label: "MAVI", color: "#2f6fa8", step: 30, offset: 210, shards: ["#1d3f68", "#2f6fa8", "#73a8c8", "#244d7d", "#366f9f", "#98c7d8", "#1b3558", "#508db8"] },
          { label: "YESIL", color: "#4f9a67", step: 24, offset: 168, shards: ["#244f36", "#4f9a67", "#82bd76", "#315f3e", "#6aa874", "#b2c985", "#1f452f", "#5f8f58", "#7ebd91"] },
          { label: "KIRMIZI", color: "#b43c36", step: 40, offset: 280, shards: ["#5c1d1b", "#b43c36", "#d07a5e", "#762620", "#9d332e", "#c45d4a", "#4a1716", "#d29670", "#8e2e29", "#be5042"] },
        ],
