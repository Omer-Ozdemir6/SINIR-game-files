  ...
  nodes: {
    ...
    n_k3_giris: {
      ...
      events: [
        ...
        { type: "note", id: "not_k3", title: "K-3: Canlı Mezar", text: "Burası bir laboratuvar değil, etten ve bitkilerden inşa edilmiş bir sindirim sistemi. Dr. Nevin tüm katı ağ gibi örmüş. Kulaklarım patlayacak gibi ama ses çıkarmak değil, yere basmak tehlikeli. Spor yataklarına basarsam beni diri diri gömecek." },
      ],
      choices: [
    ...
    n_kompost_gecit: {
      ...
      events: [
        ...
        { type: "document", open: true, doc: {
          ...
          body: "Bunu her kim bulduysa...\n\nBenim adım Selin. Nevin beni ölen kızı sandı. O canavara dönüşürken bile içindeki son insan kırıntısıyla beni korudu, bu deliğe sakladı. Onun kurtarılması gereken bir ruhu var.\n\nKendi kanımı buraya bıraktım. Nevin'in formülü kafamda: Mavi spor + kök özütü + benim kanım. Eğer doğru oranda karıştırırsan bir panzehir elde edersin ve onu bu azaptan kurtarabilirsin. Ama sakın oranı şaşırma! Yanlış bir karışım çürümeyi hızlandırır ve onu tamamen o iblisin kölesi yapar.\n\nBen aşağıya iniyorum. K-2'ye... O 'Buluntu' denen lanet şeyi susturmanın tek yolu kalbini sökmek. Beni aramaya kalkma. Ama o serumu yaparsan... yalvarırım önce Nevin'i kurtar. O iyi bir insandı.\n\n— S." } },
          { type: "note", id: "not_selin", title: "Son Parça ve Tarif", text: "Selin'in kanını aldım. Tarif net: 1 spor, 2 özüt, 3 kan = Panzehir. Yanlış yaparsam Nevin bir canavara dönüşecek. Selin K-2'ye inmiş. Üç parça da bende, laboratuvara gitme zamanı." },
