  ...
  return (
    <div style={S.overlayDim} onPointerDown={(e) => e.stopPropagation()}>
      ...
      <div style={{
        ...
        <div style={{ display: "flex", flexDirection: "column", width: "100%", maxWidth: 460, alignItems: "center", gap: 12, margin: "auto" }}>
          <div style={{ ...S.keypadTitle, width: "100%", fontSize: 13, borderBottom: "1px solid rgba(100,160,220,0.25)", paddingBottom: 6, textAlign: "center" }}>
