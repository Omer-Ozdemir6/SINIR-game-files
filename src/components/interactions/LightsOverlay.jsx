...
export default function LightsOverlay({ lights, done, onPress, onReset, onCancel }) {
  ...
  return (
    ...
    >
      <div 
        style={S.keypadPanel} 
        className={`s1-panel font-mono transition-all relative overflow-hidden ${
      ...
      >
        ...
        <div style={{ display: "flex", flexDirection: "column", width: "100%", maxWidth: 360, alignItems: "center", gap: 12, margin: "auto" }}>
          {/* BAŞLIK: DEVRE PANELİ GÖSTERGESİ */}
          <div 
            style={{ ...S.keypadTitle, width: "100%" }}
          ...
          {done && (
            <div 
              style={{ ...S.radioLockText, width: "100%" }}
