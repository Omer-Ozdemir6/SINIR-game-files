  ...
  return (
    <div style={S.overlayDim} onPointerDown={(e) => e.stopPropagation()}>
      <div style={customPanel} className="s1-panel">
        <div style={{ display: "flex", flexDirection: "column", width: "100%", maxWidth: 430, alignItems: "center", gap: 12, margin: "auto" }}>
          <div style={{ ...S.keypadTitle, width: "100%", borderBottom: "1px solid rgba(100,160,220,0.25)", paddingBottom: 6, textAlign: "center" }}>
          ...
          <div style={{ ...P.ctrlRow, width: "100%", justifyContent: "center" }}>
          ...
          {!locked && (
            <button className="s1-btn s1-menuitem" style={{ ...S.menuClose, marginTop: 4, width: "100%" }} onClick={onCancel}>{t("puzzle.cancel")}</button>
          )}
        </div>
      </div>
    </div>
    ...
    <div style={S.overlayDim} onPointerDown={(e) => e.stopPropagation()}>
      ...
      <div style={customPanel} className="s1-panel">
        <div style={{ display: "flex", flexDirection: "column", width: "100%", maxWidth: 400, alignItems: "center", gap: 12, margin: "auto" }}>
          <div style={{ ...S.keypadTitle, width: "100%", borderBottom: "1px solid rgba(100,160,220,0.22)", paddingBottom: 6, textAlign: "center" }}>
  ...
  return (
    <div style={S.overlayDim} onPointerDown={(e) => e.stopPropagation()}>
      <div style={puzzlePanel} className="s1-panel">
        <div style={{ display: "flex", flexDirection: "column", width: "100%", maxWidth: 430, alignItems: "center", gap: 12, margin: "auto" }}>
          <div style={{ ...S.keypadTitle, width: "100%", borderBottom: "1px solid rgba(100,160,220,0.22)", paddingBottom: 6, textAlign: "center" }}>{config.title || t("puzzle.symbolsTitle")}</div>
          ...
          {!done && (
            <button className="s1-btn s1-menuitem" style={{ ...S.menuClose, width: "100%" }} onClick={onCancel}>{t("puzzle.cancel")}</button>
          )}
        </div>
      </div>
    </div>
  ...
  return (
    <div style={S.overlayDim} onPointerDown={(e) => e.stopPropagation()}>
      ...
      <div style={{
        ...
        <div style={{ display: "flex", flexDirection: "column", width: "100%", maxWidth: 430, alignItems: "center", gap: 12, margin: "auto" }}>
          <div style={{ ...S.keypadTitle, color: "#a58b6f", letterSpacing: "0.14em", textAlign: "center", width: "100%" }}>
          ...
          <svg viewBox="-112 -112 224 224" style={{
            ...
            {/* Işık kırılım ışınları (Hizalandıkça parlar) */}
            ...
            {rings.map((r, i) => {
              ...
              return (
                <button
                  ...
                  onClick={() => rotate(i)}
                  disabled={done}
                  title={r.label || "Döndür"}
                >
                  {/* Rozet içi SVG çiçek deseni */}
  ...
  return (
    <div style={S.overlayDim} onPointerDown={(e) => e.stopPropagation()}>
      ...
      <div style={{
        ...
        <div style={{ display: "flex", flexDirection: "column", width: "100%", maxWidth: 320, alignItems: "center", gap: 12, margin: "auto" }}>
          <div style={{ ...S.keypadTitle, color: "#9a836a", letterSpacing: "0.14em", textAlign: "center", width: "100%" }}>
  ...
  return (
    <div style={S.overlayDim} onPointerDown={(e) => e.stopPropagation()}>
      ...
      <div style={{
        ...
        <div style={{ display: "flex", flexDirection: "column", width: "100%", maxWidth: 350, alignItems: "center", gap: 12, margin: "auto" }}>
          <div style={{ ...S.keypadTitle, color: "#a0886a", letterSpacing: "0.14em", textAlign: "center", width: "100%" }}>
          ...
          <div style={{
            ...
            HAMLE: {moves} &nbsp;|&nbsp; HİZALI: {hexagons.filter(h => h.slotIdx === h.id).length}/7
          </div>
